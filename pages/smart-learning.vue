        ...
        <v-col cols="12">
          <v-card flat>
            <v-card-text>
              ...
              <p class="gama-text-h6 mb-3">
                Your Pathway to Smart Education Solutions.
              </p>
              <p class="gama-text-subtitle1">
                Unlock the Future of Education with GamaTrain.
              </p>
              <h3 class="gama-text-h4 mt-5 mb-3">
                Personalized Learning Powered by AI
              </h3>
              <p class="gama-text-body1">
                At GamaTrain, we believe in tailoring education to fit each
                student's unique needs. Our AI-powered platform analyzes
                individual learning styles, strengths, and areas for improvement
                to provide personalized learning paths. Say goodbye to
                one-size-fits-all education - welcome to a smart, adaptive
                learning experience.
              </p>
            </v-card-text>
          </v-card>
