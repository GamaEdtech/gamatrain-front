...
import type { CommnetPostDetailAdminDTO } from '@/types'
...
const { getItemById, loadingGetItemById: loading, confirm, loadingConfirm, reject, loadingReject } = usePostCommentAdmin()

const newDataFormated = ref()
const rawData = ref<CommnetPostDetailAdminDTO>()
const commentReject = ref('')

const newDataFields: FieldConfig<CommnetPostDetailAdminDTO>[] = [
...
onMounted(async () => {
  ...
  if (response.succeeded && response.data) {
    rawData.value = response.data as CommnetPostDetailAdminDTO
    newDataFormated.value = createFormatedData(response.data as CommnetPostDetailAdminDTO, newDataFields)
  }
})
</script>
