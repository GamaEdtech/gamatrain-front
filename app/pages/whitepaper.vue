...
const whitepaperSection = ref([
  ...
  },
  {
    ...
    describe:
      ...
      + '- Community (Development and Reward) Allocation: 60% (6 billion GET), vested at 1 billion per year for 6 years.'
      + '</p>'
      + '<br>'
      ...
      + '- Platform Revenue: the platform uses a gamified system where users can earn or lose $GET. Progressing through the game requires spending $GET, and obtaining certificates also incurs a $GET cost. Additional revenue is generated through sources such as Google Ads and advertisements on the YouTube channel. <br>'
